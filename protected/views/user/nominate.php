...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'enableAjaxValidation'=>false,
		...
		<?php if($model->getError('type')){?>
			<p class="alert alert-error"><?php echo $model->getError('type');?><a class="close" data-dismiss="alert" href="#">&times;</a></p>
		<?php }?>
		<div class="control-group <?php if($model->getError('quality')){ echo 'error';}?>">
			<label class="control-label" for="User_quality"><b>Quality</b> – this award is for someone who has achieved outstanding results and sets continuously high standards, refuses to settle for current achievements and constantly strives to do more.<span class="required">*</span></label>
			<div class="controls">
		...
		<div class="control-group <?php if($model->getError('value')){ echo 'error';}?>">
			<label class="control-label" for="User_value"><b>Value</b> – this award is for someone who has gone beyond all expectations to provide more, while adding little or nothing to cost.<span class="required">*</span></label>
			<div class="controls">
		...
		<div class="control-group <?php if($model->getError('innovation')){ echo 'error';}?>">
			<label class="control-label" for="User_innovation"><b>Innovation</b> – this award is for someone who removes assumptions and restrictions to introduce new ideas and solutions through a more open way of thinking and problem solving.<span class="required">*</span></label>
			<div class="controls">
		...
		<div class="control-group <?php if($model->getError('trust')){ echo 'error';}?>">
			<label class="control-label" for="User_trust"><b>Trust</b> – this award is for someone who has achieved outstanding results and sets continuously high standards, refuses to settle for current achievements and constantly strives to do more.<span class="required">*</span></label>
			<div class="controls">
		...
		<div class="control-group <?php if($model->getError('service')){ echo 'error';}?>">
			<label class="control-label" for="User_service"><b>Service</b> – this award is for someone who has achieved outstanding results and sets continuously high standards, refuses to settle for current achievements and constantly strives to do more.<span class="required">*</span></label>
			<div class="controls">
		...
		<div class="control-group <?php if($model->getError('team')){ echo 'error';}?>">
			<label class="control-label" for="User_team"><b>Team</b> – this award is for someone who has achieved outstanding results and sets continuously high standards, refuses to settle for current achievements and constantly strives to do more.<span class="required">*</span></label>
			<div class="controls">
		...
		<div class="control-group <?php if($model->getError('itlt_award')){ echo 'error';}?>">
			<label class="control-label" for="User_itlt_award"><b>ITLT Award</b> – this award is for someone who has achieved outstanding results and sets continuously high standards, refuses to settle for current achievements and constantly strives to do more.<span class="required">*</span></label>
			<div class="controls">
