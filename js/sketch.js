...
(function($) {
  ...
  Sketch = (function() {
    function Sketch(el, opts) {
      ...
      if (this.options.toolLinks) {
        $('body').delegate("a[href=\"#" + (this.canvas.attr('id')) + "\"]", 'click', function(e) {
          ...
          if ($(this).attr('data-clean')) {
              sketch.clean();
          }
          if ($(this).attr('data-save')) {
              sketch.save($(this).attr('data-save'));
          }
    ...
    Sketch.prototype.clean = function(){
    ...
    Sketch.prototype.save = function(filename){
    	...
    	$.post( "../save" , 
    			...
    			'User[guest_travel_ticket][]' : guest_travels,
    			 filename : filename,
    				...
    				if(data =='Success'){
    					alert(data);
    					location.href="../searchIpad";
    				}else if(data == 'has_ipad'){
    					location.href=$('#User_id').val();
    				}else{
    					alert(data);
    					$("#save").text('Save');
    			    	$("#save").removeClass('btn-inverse');
