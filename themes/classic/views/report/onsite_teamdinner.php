				...
				<table class="table table-bordered table-hover table-striped">
					...
					<tbody>
						...
						<tr>
							...
							</td><td><?php echo isset($total[$teamdinner])?CHtml::link($total[$teamdinner],array('report/onsiteExportTeamDietary','team_dinner'=>$teamdinner,'team_dinner_menu'=>'')):0?></td>
							<td><?php echo isset($meat[$teamdinner])?CHtml::link($meat[$teamdinner],array('report/onsiteExportTeamDietary','team_dinner'=>$teamdinner,'team_dinner_menu'=>'Meat')):0?></td>
							<td><?php echo isset($fish[$teamdinner])?CHtml::link($fish[$teamdinner],array('report/onsiteExportTeamDietary','team_dinner'=>$teamdinner,'team_dinner_menu'=>'Fish')):0?></td>
							<td><?php echo isset($vegetarian[$teamdinner])?CHtml::link($vegetarian[$teamdinner],array('report/onsiteExportTeamDietary','team_dinner'=>$teamdinner,'team_dinner_menu'=>'Vegetarian')):0?></td>
						</tr>
						<?php }}?>
					</tbody>
				</table>
